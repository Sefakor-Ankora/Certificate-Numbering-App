            ...
            <div class="row-fluid">
                ...
                <div class="span10">
                    ...
                    <div class="row-fluid hero-unit">
                                          <div id="" class="">
                        <h4>Modify Cadastral Record for  <?php  echo $session->locname  ?></h4> 
                        <p>&nbsp;</p>
                    </div>
                        <form id="newform" action="" method="POST">
                          ...
                          <input type="text" name="lno" value="<?php  echo $record->lno ?>" class="input-block-level required-entry"  required="" />
                            ...
                            <input readonly="" type="text" name="pno" value="" class="input-block-level"  />
                        </div>
                            <div class="span6">
                          ...
                          <input type="text" name="plno" value="<?php  echo $record->plno ?>" class="input-block-level required-entry"  required="" />
                            ...
                            <input readonly="" type="text" id="volume" value="<?php  echo $record->volume ?>" name="volume" class="input-block-level required-entry"  required="" />                   
                            <label class="">SECTION</label>
                            <input type="text" name="section" value="" class="input-block-level" readonly="" />                          <label class="">LAST FOLIO NO.</label>
                          <input readonly="" type="text" id="lfn" value="<?php  echo $record->folio - 1 ?>" class="input-block-level required-entry"  required="" />
